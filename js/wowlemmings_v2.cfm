<cfsilent>
	...
	<!--- combo of: 
	<script type="text/javascript" src="/js/cookies.cfm"></script>
	<script type="text/javascript" src="/js/wowlemmings.cfm"></script>
	<script type="text/javascript" src="/CFIDE/scripts/wddx.js"></script>
	<script type="text/javascript" src="/js/wddxdata.cfm"></script>
	--->
</cfsilent>
...
<cfsilent><cfinclude template="/qry_servers.cfm"></cfsilent>
<cfwddx action="cfml2js" input="#qryServers#" toplevelvariable="jsServers">