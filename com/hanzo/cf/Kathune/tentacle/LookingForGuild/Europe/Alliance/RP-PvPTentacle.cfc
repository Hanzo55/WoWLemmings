<cfcomponent displayname="RP-PvPTentacle" output="false" extends="com.hanzo.cf.Kathune.tentacle.LookingForGuild.Europe.Alliance.AllianceTentacle" implements="com.hanzo.cf.Kathune.interface.ITentacle">

	<cffunction name="init" returntype="com.hanzo.cf.Kathune.tentacle.LookingForGuild.Europe.Alliance.RP-PvPTentacle" access="public" output="false">
